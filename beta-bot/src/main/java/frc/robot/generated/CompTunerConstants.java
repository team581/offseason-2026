...
public class CompTunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.25).withKI(0).withKD(0).withKS(0.2).withKV(0.124);
  ...
  private static final TalonFXConfiguration driveInitialConfigs =
      new TalonFXConfiguration()
          .withCurrentLimits(new CurrentLimitsConfigs().withSupplyCurrentLimit(Amps.of(40))).withMotorOutput(new MotorOutputConfigs().withDutyCycleNeutralDeadband(0.0));
