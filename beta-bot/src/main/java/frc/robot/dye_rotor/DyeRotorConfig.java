...
public class DyeRotorConfig {
  ...
  public static final double GP_DETECT_VELOCITY_THRESHOLD = 140.0;

  // TODO: Measure this number
  public static final double RPM_TOLERANCE_SHOOTING = 10;

  public static final double FULL_SPEED_BPS = 25;
  ...
  public static final DoubleSubscriber UNJAM_TIMEOUT = DogLog.tunable("DyeRotor/UnjamTimeout", 0.5);
