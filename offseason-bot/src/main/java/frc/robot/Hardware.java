...
public class Hardware {
  ...
  public final Limelight shooterLimeLight = new Limelight("shooter", LimelightState.OFF, null);
  public final Limelight leftLimeLight = new Limelight("left", LimelightState.OFF, null);
  public final Limelight rightLimeLight = new Limelight("right", LimelightState.OFF, null);
  public final Limelight groundLimeLight = new Limelight("ground", LimelightState.OFF, null);
