...
public class FieldUtil {
  ...
  // calculations
  private static final double RED_ROBOT_STARTING_LINE_X = Units.inchesToMeters(156.61);
  private static final double BLUE_ROBOT_STARTING_LINE_X = FIELD_LENGTH - RED_ROBOT_STARTING_LINE_X;

  private static final double RED_TRENCH_X = Units.inchesToMeters(182.11);
  private static final double BLUE_TRENCH_X = FIELD_LENGTH - RED_TRENCH_X;

  private static final double TRENCH_TO_ROBOT_STARTING_LINE_DISTANCE_X =
      RED_TRENCH_X - RED_ROBOT_STARTING_LINE_X;

  private static final double RED_BOX_COORDINATE_X =
      TRENCH_TO_ROBOT_STARTING_LINE_DISTANCE_X + RED_ROBOT_STARTING_LINE_X;
  private static final double BLUE_BOX_COORDINATE_X =
      BLUE_TRENCH_X - TRENCH_TO_ROBOT_STARTING_LINE_DISTANCE_X;

  private static final double TRENCH_LENGTH_Y = Units.inchesToMeters(25.62 * 2);
  private static final double OPPOSITE_TRENCH_COORDINATE_Y = FIELD_WIDTH - TRENCH_LENGTH_Y;
  // end of calculations
