...
public class DyeRotor extends StateMachineSubsystem<DyeRotorState> {
  ...
  protected void whileInState(DyeRotorState currentState) {
    ...
    DogLog.log("DyeRotor/Rotor/StatorCurrent", rotorMotor.getStatorCurrent().getValueAsDouble());
    ...
    DogLog.log(
        "DyeRotor/Horizontal/StatorCurrent", horizontalMotor.getStatorCurrent().getValueAsDouble());
    ...
    DogLog.log(
        "DyeRotor/Vertical/StatorCurrent", verticalMotor.getStatorCurrent().getValueAsDouble());
