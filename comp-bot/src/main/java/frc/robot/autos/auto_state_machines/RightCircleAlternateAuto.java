...
public class RightCircleAlternateAuto extends BaseImperativeAuto<CircleSoMAutoState> {
  ...
  private final AutoSegment intakeAcrossMidline =
      Trailblazer.segment(
              ...
              AutoPoint.ofRed(
                      new Pose2d(
                          11.0, FieldUtil.RED_OUTPOST_TRENCH_CENTER.getY(), Rotation2d.kCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100))
                  .withAngularConstraints(Units.rotationsToRadians(4), Units.rotationsToRadians(4)),
              AutoPoint.ofRed(new Pose2d(9.449, 7.21, Rotation2d.kCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100))
                  .withAngularConstraints(Units.rotationsToRadians(4), Units.rotationsToRadians(4)),
  ...
  public RightCircleAlternateAuto(RobotManager robotManager, Trailblazer trailblazer) {
