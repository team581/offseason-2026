...
public class LeftSpecialAuto extends BaseImperativeAuto<SpecialAutoState> {
  ...
  private final AutoSegment intakeAcrossMidline =
      Trailblazer.segment(
              AutoPoint.ofRed(
                      new Pose2d(
                          9.956, FieldUtil.RED_DEPOT_TRENCH_CENTER.getY(), Rotation2d.kCCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.4, 100)),
              AutoPoint.ofRed(new Pose2d(7.572, 0.634, Rotation2d.kCCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.4, 100)),
              AutoPoint.ofRed(new Pose2d(5.773 + 0.35, 6.229, Rotation2d.kCCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.4, 100)),
              AutoPoint.ofRed(new Pose2d(5.773 + 0.35, 4.298, Rotation2d.kCCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100)),
              AutoPoint.ofRed(new Pose2d(7.572, 4.53, Rotation2d.kZero))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100)),
  ...
  private final AutoSegment defaultSecondSegment =
      Trailblazer.segment(
              ...
              AutoPoint.ofRed(
                  ...
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100)),
              AutoPoint.ofRed(
                  new Pose2d(10.5, FieldUtil.RED_DEPOT_TRENCH_CENTER.getY(), Rotation2d.k180deg)),
              AutoPoint.ofRed(new Pose2d(9.5 - 1.0, 6.814, Rotation2d.kCCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100)),
              AutoPoint.ofRed(new Pose2d(9.5 - 1.0, 4.4 + MIDLINE_OFFSET, Rotation2d.kCCW_90deg))
  ...
  public LeftSpecialAuto(RobotManager robotManager, Trailblazer trailblazer) {
  ...
  protected void collectInputs() {
    super.collectInputs();
    if (getState() == SpecialAutoState.STARTING_WITH_DELAY
        && DriverStation.isEnabled()
        && robotManager.localization.imu.collisionDetected()) {
      collisionEverDetected = true;
    }

    DogLog.log("LeftSpecialAuto/CollisionDetected", collisionEverDetected);
  }
