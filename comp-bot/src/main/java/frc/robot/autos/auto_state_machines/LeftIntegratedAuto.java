...
public class LeftIntegratedAuto extends BaseImperativeAuto<IntegratedAutoState> {
  ...
  private final AutoSegment intakeAcrossMidline =
      Trailblazer.segment(
              ...
              AutoPoint.ofRed(
                      new Pose2d(
                          9.975, FieldUtil.RED_DEPOT_BUMP_CENTER.getY(), Rotation2d.kCW_90deg))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100)),
              AutoPoint.ofRed(
                      new Pose2d(
                          11.174, FieldUtil.RED_DEPOT_BUMP_CENTER.getY(), Rotation2d.kCW_90deg))
              ...
              AutoPoint.of(
                      () ->
                          bumpCrossingTracker.getPoint(
                              ...
                              Point.ofRed(new Pose2d(13.9, 2.476, Rotation2d.kCW_90deg))))
                  .withTransitionTolerance(new PoseErrorTolerance(0.3, 100))
                  .withLinearConstraints(4.5, 8),
              AutoPoint.ofRed(
                      new Pose2d(
  ...
  private final AutoSegment driveBackAndShootTwo =
      Trailblazer.segment(
              AutoPoint.ofRed(
                      new Pose2d(
                          10.8, FieldUtil.RED_DEPOT_BUMP_CENTER.getY(), Rotation2d.kCW_90deg))
                  .withAngularConstraints(
