...
public class Imu extends BaseImuSubsystem {
  ...
  public void collectInputs() {
    ...
    double pigeonFilteredXAccel = pigeonXAccelFilter.calculate(drivetrain.getPigeon2().getAccelerationX().getValueAsDouble());
    double pigeonFilteredYAccel = pigeonYAccelFilter.calculate(drivetrain.getPigeon2().getAccelerationY().getValueAsDouble());
