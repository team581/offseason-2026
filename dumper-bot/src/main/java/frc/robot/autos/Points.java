...
public enum Points {
  ...
  INTAKE_MIDLINE_RIGHT(
     Point.ofRed(new Pose2d(9.64, 5.938, Rotation2d.fromDegrees(180)))),
  INTAKE_MIDLINE_LEFT(
     Point.ofRed(new Pose2d(9.64, 2.154, Rotation2d.fromDegrees(180)))),
  INTAKE_DEPOT(
     Point.ofRed(new Pose2d(15.469, 2.118, Rotation2d.fromDegrees(0.0)))),
