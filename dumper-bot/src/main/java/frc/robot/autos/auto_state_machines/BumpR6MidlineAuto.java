...
public class BumpR6MidlineAuto extends BaseImperativeAuto<BumpR6MidlineAutoState> {
  ...
  private final AutoSegment segment1DriveToMidline =
      Trailblazer.segment(AutoPoint.ofRed(new Pose2d(12.996, 6.0, Rotation2d.fromDegrees(180.0))),
      AutoPoint.ofRed(new Pose2d(11.912, 5.482, Rotation2d.fromDegrees(180.0))),
      AutoPoint.ofRed(new Pose2d(10.218, 5.482, Rotation2d.fromDegrees(180.0))))
      .untilFinished(new PoseErrorTolerance(0, null));

  private final AutoSegment segment2IntakeAcrossMidline =
      Trailblazer.segment(AutoPoint.ofRed(new Pose2d(10.218, 5.482, Rotation2d.fromDegrees(-90.0))),
      AutoPoint.ofRed(new Pose2d(10.218, 4.341, Rotation2d.fromDegrees(-90.0))),
      AutoPoint.ofRed(new Pose2d(10.218, 2.885, Rotation2d.fromDegrees(-90.0))))
      .untilFinished(new PoseErrorTolerance(0, null));

  private final AutoSegment segment3DriveBack = 
      Trailblazer.segment(AutoPoint.ofRed(new Pose2d(10.218, 2.885, Rotation2d.fromDegrees(90))),
      AutoPoint.ofRed(new Pose2d(10.218, 4.341, Rotation2d.fromDegrees(90))),
      AutoPoint.ofRed(new Pose2d(10.218, 5.482, Rotation2d.fromDegrees(180))),
      AutoPoint.ofRed(new Pose2d(11.912, 5.482, Rotation2d.fromDegrees(180))),
      AutoPoint.ofRed(new Pose2d(13.751, 5.482, Rotation2d.fromDegrees(180))))
      .untilFinished(new PoseErrorTolerance(0, null));

  private final AutoSegment segment4DriveToShoot =
      Trailblazer.segment(AutoPoint.ofRed(new Pose2d(13.751, 5.82, Rotation2d.fromDegrees(0))),
  ...
  protected void whileInState(BumpR6MidlineAutoState newState) {
    switch (newState) {
      case SEGMENT_1_DRIVE_TO_MIDLINE -> robotManager.swerve.trailblazerDriveRequest(segment1DriveToMidline);
      ...
      case SEGMENT_4_DRIVE_TO_SHOOT -> robotManager.swerve.trailblazerDriveRequest(segment4DriveToShoot);
      case DONE -> {}
    }
  }
}
